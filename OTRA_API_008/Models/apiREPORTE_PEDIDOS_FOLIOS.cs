...
{
    public class apiREPORTE_PEDIDOS_FOLIOS
    {
        ...
        public Newtonsoft.Json.Linq.JArray REPORTE_PED_FOLIOS()
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SP_REPORTE_LOGISTICA_PEDIDOS", CONECT))
