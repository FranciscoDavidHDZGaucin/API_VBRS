...
{
    public class VERSA_VTS_VS_GOPC_SP_2018
    {
        private SqlDataReader drd;

        public List<DataTable> _RES_TOTALES = null;

        public Newtonsoft.Json.Linq.JArray Vts_2018()
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SP_VRS_VENTAS_AND_NCQV_2018", CONECT))
