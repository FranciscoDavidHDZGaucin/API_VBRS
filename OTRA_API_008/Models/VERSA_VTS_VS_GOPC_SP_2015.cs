...
{
    public class VERSA_VTS_VS_GOPC_SP_2015
    {
        ...
        public Newtonsoft.Json.Linq.JArray Vts_2015()
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SP_VRS_VENTAS_AND_NCQV_2015", CONECT))
