...
namespace OTRA_API_008.Models
{
                            ...
                            fech_real = Convert.ToDateTime(drd["FECHA_REAL"]).ToString("yyyy-MM-dd");
                                ...
                                VTS_AND_NCQV ROW_OBJT  = new VTS_AND_NCQV
                                {
                                 ...
                                 SEM_PROGRAMADA = Convert.ToInt32(drd["SEM_PROGRAMADA"]),
                                    ...
                                    DocCurFactura = drd["DocCurFactura"].ToString(),
                                    DocRateFactura = drd["DocRateFactura"].ToString(),
                                    DocTotalFCFactura = drd["DocTotalFCFactura"].ToString(),
                                    DocCur = drd["DocCur"].ToString(),
                                    DocRate = drd["DocRate"].ToString(),
                                    DocTotalFC = drd["DocTotalFC"].ToString()
    ...
    public class VTS_AND_NCQV
    {
        ...
        public string DocCurFactura { get; set; }
        public string DocRateFactura { get; set; }
        public string DocTotalFCFactura { get; set; }
