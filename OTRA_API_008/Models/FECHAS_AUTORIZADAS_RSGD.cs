...
namespace OTRA_API_008.Models
{
    public class FECHAS_AUTORIZADAS_RSGD
    {
        ...
        //    const string SELECPLATFORM = "SELECT  [ID_DIA] ,[FECHCORTA],[FECH_LGMX] ,[FECH_LGUS],[FECH_INI_MES],[FECH_FINMES] ,[DIAS_MES] ,[ANIO] ,[NUM_MES],[DIA] ,[MES]  ,[SEMANA_EMPIEZADOM]   ,[SEMANA_EMPIEZAENLUN] ,[DIA_SEMANA],[TRIMESTRE] ,[SEMESTRE],[ESTACION_NORTE],[ESTACION_SUR] ,[SEMANA RSGD] as SEMANARSGD FROM [JUPITER].[dbo].[TB_PERIODO_RSGD_AUTO]";
        ...
        //                            FECHCORTA = Convert.ToDateTime(drd["FECHCORTA"]).Date.ToString(),
        //                            FECH_LGMX = Convert.ToDateTime(drd["FECH_LGMX"]).Date.ToString(),
        //                            FECH_LGUS = Convert.ToDateTime(drd["FECH_LGUS"]).Date.ToString(),
        //                            FECH_INI_MES = Convert.ToDateTime(drd["FECH_INI_MES"]).Date.ToString(),
        //                            FECH_FINMES = Convert.ToDateTime(drd["FECH_FINMES"]).Date.ToString(),
