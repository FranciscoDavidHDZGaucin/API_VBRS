...
{
    public class api_GOPC_PLAN_MAESTRO_TIPO
    {
        private SqlDataReader drd;

        public List<DataTable> _RES_TOTALES = null;

        public Newtonsoft.Json.Linq.JArray PLAN_MAESTRO(String tipo)
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SP_GOPC_PLAN_MAESTRO_PS1_VRS_002_POR_TIPO", CONECT))
