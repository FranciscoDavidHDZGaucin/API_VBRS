...
{
    public class apiVTS_NOTAS_DE_CREDITO
    {
        public FILTRONOTAS _FILTRO_CNTRL = new FILTRONOTAS();
        public List<VTS_AND_NCQVNOTAS> _ResObjeto = null;
        ...
        public apiVTS_NOTAS_DE_CREDITO()
        {

            _FILTRO_CNTRL = GET_FILTRO();
            CALL_SP_VENTASVRSNC();
        }
        public FILTRONOTAS GET_FILTRO()
        {
            FILTRONOTAS objfiltro = new FILTRONOTAS();
            SqlDataReader drd;
            try
            {
        ...
        public Newtonsoft.Json.Linq.JArray CALL_SP_VENTASVRSNC()
        {
            ...
            List<VTS_AND_NCQVNOTAS> LISTAREULTADO = new List<VTS_AND_NCQVNOTAS>();
            try
            {
                ...
                {
                    CONEECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SP_NOTASCREDITO", CONEECT))
                    {
                        ...
                        while (drd.Read())
                        {
                            ...
                            VTS_AND_NCQVNOTAS ROW_OBJT = new VTS_AND_NCQVNOTAS
                            {
        ...
        private List<VTS_AND_NCQVNOTAS> LIST_OBJETOS(DataTable ventas_vrs)
        {


            var _LISTA_VENTAS = (from DRD in ventas_vrs.AsEnumerable()
                                 select new VTS_AND_NCQVNOTAS()
                                 {
    ...
    public class VTS_AND_NCQVNOTAS
    {
