...
{
    public class api_VENTAS_ANIOS_PASADOS_2015_2017
    {
        ...
        public Newtonsoft.Json.Linq.JArray PLAN_MAESTRO()
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SELECT * FROM TB_VENTAS_ANIOS_PASADOS WHERE ANIO >2015 and ANIO < 2018", CONECT))
