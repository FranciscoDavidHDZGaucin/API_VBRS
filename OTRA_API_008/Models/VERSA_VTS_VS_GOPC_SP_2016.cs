...
{
    public class VERSA_VTS_VS_GOPC_SP_2016
    {
        ...
        public Newtonsoft.Json.Linq.JArray Vts_2016()
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SP_VRS_VENTAS_AND_NCQV_2016", CONECT))
