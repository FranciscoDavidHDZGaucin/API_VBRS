...
namespace OTRA_API_008.Models
{
    public class api_QtyFillRate
    {
        ...
        public Newtonsoft.Json.Linq.JArray QtyFillRate_FACTURAS_BACK_ORDER()
        {
            ...
            try
            {
                ...
                {
                    CONECT.Open();
                    using (SqlCommand COMANDO = new SqlCommand("SELECT * FROM VW_QtyFillRate_FACTURA_BACK_ORDER", CONECT))
